...
#define INPUT_BUTTON_UP_PIN				NRF_GPIO_PIN_MAP(0, 28)
#define INPUT_BUTTON_DOWN_PIN			NRF_GPIO_PIN_MAP(0, 3)
#define INPUT_BUTTON_LEFT_PIN			NRF_GPIO_PIN_MAP(0, 5)
#define INPUT_BUTTON_RIGHT_PIN			NRF_GPIO_PIN_MAP(0, 29)
...
#define DISPLAY_LED_APA102_SCK_PIN			NRF_GPIO_PIN_MAP(0, 26)
#define DISPLAY_LED_APA102_MOSI_PIN			NRF_GPIO_PIN_MAP(0, 27)
#define DISPLAY_LED_APA102_COLOR_ORDER		DISPLAY_LED_RGB_COLOR_ORDER_RBG
